...
```
cd existing_repo
git remote add origin https://gitlab.wiss-edu.ch/m324-devops/todolist-backend.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.wiss-edu.ch/m324-devops/todolist-backend/-/settings/integrations)
